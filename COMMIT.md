...
## Для ui библиотеки
````
Изучи изменения, обнови версию проекта согласно правилам обновления версий в npm библиотеках, напиши сообщение коммита на англиском языке
Текс должен быть обернут в текстовый блок, для удобства копирования см пример
- Примеры:
```text
fix(Page404): исправлены стили высоты и адаптивности страницы 404
- Обновлён min-height для .root с использованием Выполни команду пуш100dvh в комопненте container
- Исправлены медиазапросы в компоненте Page
- Уточнены отступы и размеры в компоненте Layout
```
